...
*/
    ...
    @TableName("ex_outersystem")
    public class ExOutersystem implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    private Boolean costtplshow;
        ...
        @TableField("etltplshow")
    private Boolean etltplshow;

        @TableField("des_sys_show")
    private Boolean desSysShow;

        @TableField("glshow")
    private Boolean glshow;
