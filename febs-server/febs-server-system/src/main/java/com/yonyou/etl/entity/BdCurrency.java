...
*/
    ...
    public class BdCurrency implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    private String parentid;
        ...
        @TableField("moneydigit")
    private Integer moneydigit;

        @TableField("moneyrount")
    private String moneyrount;

        @TableField("pricedigit")
    private Integer pricedigit;

        @TableField("pricerount")
    private String pricerount;
