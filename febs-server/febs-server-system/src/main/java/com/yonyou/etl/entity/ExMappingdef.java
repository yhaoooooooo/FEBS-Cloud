...
*/
    ...
    @TableName("ex_mappingdef")
    public class ExMappingdef implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    private String parentid;
        ...
        @TableField("des_action")
    private String desAction;

        @TableField("des_billtype")
    private String desBilltype;

        @TableField("des_system")
    private String desSystem;

        @TableField("effector")
    private String effector;

        @TableField("src_action")
    ...
    private String version;
        ...
        @TableField("des_tradetype")
    private String desTradetype;
    ...
    private String accpurposes;
        ...
        @TableField("target_voctype")
    private String targetVoctype;
