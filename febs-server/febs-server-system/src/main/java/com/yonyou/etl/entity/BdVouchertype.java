...
private static final long serialVersionUID = 1L;
    ...
    private String accbook;
        ...
        @TableField("voucherstr")
    private String voucherstr;

        @TableField("voucherstr2")
    private String voucherstr2;

        @TableField("voucherstr3")
    private String voucherstr3;

        @TableField("voucherstr4")
    private String voucherstr4;

        @TableField("voucherstr5")
    private String voucherstr5;

        @TableField("voucherstr6")
    private String voucherstr6;
