...
*/
    ...
    @TableName("coa_hangbill_part")
    public class CoaHangbillPart implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    private String accpurposes;
        ...
        @TableField("dynpercent")
    private String dynpercent;
    ...
    private String origin;
        ...
        @TableField("rulemny")
    private String rulemny;

        @TableField("dymny")
    private String dymny;

        @TableField("aftcoamny")
    private String aftcoamny;

        @TableField("b4mny")
    private String b4mny;

            /**
            * undertaking rule id
            */
        @TableField("parentrule")
    ...
    private String reason;
        ...
        @TableField("finalFlag")
    private String finalflag;

        @TableField("finalmny")
    private String finalmny;
