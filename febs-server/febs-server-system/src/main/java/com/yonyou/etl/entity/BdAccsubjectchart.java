...
*/
    ...
    @TableName("bd_accsubjectchart")
    public class BdAccsubjectchart implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    private String showStyle;
        ...
        @TableField("subject_name_separator")
    private String subjectNameSeparator;
    ...
    private String srctplid;
        ...
        @TableField("sharesub")
    private Boolean sharesub;

        @TableField("refaccsubjectchart")
    private String refaccsubjectchart;
