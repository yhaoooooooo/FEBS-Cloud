...
*/
    ...
    @TableName("coa_allocplan")
    public class CoaAllocplan implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    private Blob dimensions;

        @TableField("accsubjects")
    private Blob accsubjects;
    ...
    private String version;
        ...
        @TableField("datatimepoint")
    private String datatimepoint;

        @TableField("ruleexeway")
    private String ruleexeway;

        @TableField("costelement")
    private String costelement;

        @TableField("coamodelparametercode")
    private String coamodelparametercode;
