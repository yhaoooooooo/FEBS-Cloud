...
*/
    ...
    @TableName("bd_doctype")
    public class BdDoctype implements Serializable {
...
private static final long serialVersionUID = 1L;
    ...
    private String accessorclass;
        ...
        @TableField("canVersioned")
    private Boolean canversioned;

        @TableField("entityid")
    private String entityid;

        @TableField("hasClassify")
    private Boolean hasclassify;

        @TableField("hasLevel")
    private Boolean haslevel;

        @TableField("treeInfoTable")
    private String treeinfotable;
